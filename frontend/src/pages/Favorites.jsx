...
const Favorites = () => {
  ...
  const handleRemove = async (hotelId) => {
    try {
      ...
      setActionError('Failed to remove favorite');
    }
  };
              ...
              <div className="modern-card hover-lift h-100 d-flex flex-column">
                ...
                <div className="p-4 d-flex flex-column flex-grow-1">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <h5 className="fw-bold font-serif text-primary mb-0">{fav.name}</h5>
                  </div>
                  ...
                  <div className="mt-auto d-flex gap-2">
                    <Link to={`/hotels/${fav.id}`} className="btn btn-primary flex-grow-1">View Details</Link>
                    <button type="button" onClick={() => handleRemove(fav.id)} className="btn btn-outline-danger px-3" title="Remove from favorites">
